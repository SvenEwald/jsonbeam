 ...
 *
 */
public class ByteBufferCharacterSourceASCII extends BytesCharacterSourceASCII{
	 ...
	 * @param length
	 */
	public ByteBufferCharacterSourceASCII(ByteBuffer bytes,int offset,int length) {
		super(offset,length);
		this.buffer=bytes;
	}
	...
	{
		ByteBufferCharacterSourceASCII source = new ByteBufferCharacterSourceASCII(buffer,pos,max);
		return source;
	}
	/**
	 * {@inheritDoc}
