 ...
 * @author sven
 */
public abstract class BytesCharacterSourceUTF8 extends EncodedCharacterSource {
	//storing state to decode UTF8 sequences that produce multiple chars
	private int prevThirdByte = 0;

	public BytesCharacterSourceUTF8(int offset, int length) {
		super(offset, length, StandardCharsets.UTF_8);
	};
