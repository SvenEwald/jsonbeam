 ...
 * @author sven
 */
public abstract class BytesCharacterSourceUTF16LE extends EncodedCharacterSource {
	
	public BytesCharacterSourceUTF16LE(int offset,int length) {
		super(offset,length,StandardCharsets.UTF_16LE);
	};
