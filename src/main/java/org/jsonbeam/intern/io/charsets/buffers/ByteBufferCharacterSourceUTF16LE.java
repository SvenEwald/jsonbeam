...
import org.jsonbeam.intern.io.charsets.BytesCharacterSourceUTF16LE;

/**
 * @author sven
 *
 */
public class ByteBufferCharacterSourceUTF16LE extends BytesCharacterSourceUTF16LE{
	 ...
	 * @param length
	 */
	public ByteBufferCharacterSourceUTF16LE(ByteBuffer bytes,int offset,int length) {
		super(offset,length);
		this.buffer=bytes;
	}
	...
	{
		ByteBufferCharacterSourceUTF16LE source = new ByteBufferCharacterSourceUTF16LE(buffer,pos,max);
		return source;
	}
	/**
	 * {@inheritDoc}
