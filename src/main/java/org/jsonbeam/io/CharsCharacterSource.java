 ...
 * @author Sven
 */
public class CharsCharacterSource extends BaseCharacterSourceImpl {

	final private char[] buffer;

	public CharsCharacterSource(char[] json) {
		super(null);
		this.buffer = json;
		max = buffer.length - 1;
	}
	...
	public CharacterSource getSourceFromPosition(int pos) {
		CharsCharacterSource source = new CharsCharacterSource(buffer);
